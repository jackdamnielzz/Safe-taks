...
export default function BillingPage() {
  ...
  const handlePlanChange = async (newPlan: string) => {
    ...
    try {
      ...
      showMessage(
        "success",
        `Successfully upgraded to ${plans[newPlan as keyof typeof plans].name}`
      );
    } catch (error) {
  ...
  const validatePaymentForm = () => {
    ...
    if (selectedPaymentMethod === "bancontact") {
      if (
        !paymentForm.bancontactCardNumber ||
        paymentForm.bancontactCardNumber.replace(/\s/g, "").length < 16
      ) {
    ...
    if (selectedPaymentMethod === "sepa") {
      if (
        !paymentForm.iban ||
        !/^[A-Z]{2}\d{2}[A-Z0-9]{1,30}$/.test(paymentForm.iban.replace(/\s/g, ""))
      ) {
  ...
  const handleSavePaymentMethod = async (isEdit: boolean) => {
    ...
    try {
      ...
      showMessage(
        "success",
        isEdit ? "Betaalmethode bijgewerkt" : "Nieuwe betaalmethode toegevoegd"
      );
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">Onbeperkt in Professional plan</p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">23% van 10 GB limiet gebruikt</p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {usageStats.api_calls.toLocaleString("nl-NL")}
              </div>
              <p className="text-xs text-muted-foreground">15,420 verzoeken deze maand</p>
            </CardContent>
          </Card>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between p-4 border rounded-lg">
              ...
              {paymentMethod.is_default && <Badge variant="secondary">Standaard</Badge>}
            </div>
      ...
      {activeTab === "history" && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>Overzicht van alle facturen en betalingen</CardDescription>
          </CardHeader>
          <CardContent>
      ...
      {activeTab === "plans" && (
        <div className="grid gap-6 md:grid-cols-3">
          {Object.entries(plans).map(([key, plan]) => (
            <Card
              key={key}
              className={`relative ${subscription.plan === key ? "ring-2 ring-blue-500" : ""}`}
            >
      ...
      {subscription.status === "trial" && (
        <Alert className="mt-8" title="Proefperiode Eindigt Spoedig">
          <div className="flex items-start gap-3">
            ...
            <div>
              Uw proefperiode eindigt op {formatDate(subscription.trial_end!)}. Upgrade naar een
              betaald plan om uw account actief te houden.
            </div>
          </div>
        </Alert>
      )}
      ...
      {subscription.cancel_at_period_end && (
        <Alert className="mt-8" title="Abonnement Wordt Geannuleerd">
          <div className="flex items-start gap-3">
            ...
            <div>
              Uw abonnement wordt geannuleerd aan het einde van de huidige periode op{" "}
              {formatDate(subscription.current_period_end)}. U kunt dit annuleren om uw abonnement
              actief te houden.
            </div>
          </div>
        </Alert>
                  ...
                  >
                    ...
                    <div className="text-left">
                      ...
                      <div className="text-sm text-gray-600">
                        Bankoverschrijving via Nederlandse banken
                      </div>
                    </div>
                  </button>
              ...
              <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        <select
                          ...
                          onChange={(e) =>
                            handleInputChange("bancontactExpiryMonth", e.target.value)
                          }
                          className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-red-500 ${
                      ...
                      <div>
                        ...
                        <select
                          ...
                          onChange={(e) =>
                            handleInputChange("bancontactExpiryYear", e.target.value)
                          }
                          className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-red-500 ${
                            formErrors.bancontactExpiry ? "border-red-500" : "border-gray-300"
                          }`}
                  ...
                  <div className="space-y-4">
                    <div className="text-center p-4 bg-blue-50 rounded-lg">
                      ...
                      <div className="text-blue-600 text-sm">
                        Maandelijkse automatische afschrijving
                      </div>
                    </div>
                    ...
                    <div className="bg-yellow-50 p-3 rounded-lg">
                      <p className="text-yellow-800 text-sm">
                        <strong>Let op:</strong> Door verder te gaan geeft u SafeWork Pro
                        toestemming om maandelijks het abonnementsbedrag automatisch van uw rekening
                        af te schrijven.
                      </p>
                    </div>
                  </div>
                ...
                <div className="flex items-center">
                  <input
                    ...
                    onChange={(e) =>
                      handleInputChange("isDefault", e.target.checked ? "true" : "false")
                    }
                    className="mr-2"
                  />
