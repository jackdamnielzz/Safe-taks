...
jest.mock('@/lib/stopWorkService', () => ({
  ...
  getStopWorkCategoryLabel: jest.fn((category: 'weather' | 'equipment' | 'personnel' | 'hazard' | 'other') => {
...
describe('StopWorkButton', () => {
  ...
  describe('Form Inputs', () => {
    ...
    it('should enforce character limits', () => {
      ...
      const descriptionInput = screen.getByLabelText(/beschrijving \(gedetailleerd\)/i) as HTMLTextAreaElement;
  ...
  describe('Signature Step', () => {
    ...
    it('should show error when submitting without signature', () => {
      const submitButton = screen.getByRole('button', { name: /stop werk bevestigen/i });
      fireEvent.click(submitButton);
      
      expect(screen.getByText(/handtekening is verplicht/i)).toBeInTheDocument();
    });
  ...
  describe('Alert Submission', () => {
    ...
    it('should show error message when submission fails', async () => {
      mockStopWorkService.createStopWorkAlert.mockRejectedValue(
